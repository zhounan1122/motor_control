...
//	EPwm1Regs.AQCSFRC.all=0;
	EPwm1Regs.AQCTLA.bit.CAU = AQ_SET;	    //force low
	EPwm1Regs.AQCTLA.bit.CAD = AQ_CLEAR;	//force high
...
//	EPwm1Regs.AQCTLB.bit.PRD = 1;
	...
	EPwm1Regs.DBCTL.bit.POLSEL = DB_ACTV_HIC;		//AHC mode,b invert
	...
	//	EPwm1Regs.AQSFRC.all=0;
	//	EPwm1Regs.AQCSFRC.all=0;
	EPwm2Regs.AQCTLA.bit.CAU = AQ_SET;	    //force low
	EPwm2Regs.AQCTLA.bit.CAD = AQ_CLEAR;	//force high
	...
	EPwm2Regs.DBCTL.bit.POLSEL = DB_ACTV_HIC;		//AHC mode,b invert
